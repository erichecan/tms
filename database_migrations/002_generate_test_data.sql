...
INSERT INTO customers (id, tenant_id, name, email, level, contact_info, created_at, updated_at)
VALUES 
    ('20000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'Walmart Canada', 'john.doe@walmart.ca', 'standard', jsonb_build_object('phone', '+1 (416) 555-0101', 'contactPerson', 'John Doe', 'address', jsonb_build_object('street', '3401 Dufferin St', 'city', 'North York', 'province', 'ON', 'postal_code', 'M6A 2T9', 'country', 'Canada', 'latitude', 43.7615, 'longitude', -79.4635)), NOW(), NOW()),
    ('20000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'Costco Toronto', 'jane.smith@costco.ca', 'standard', jsonb_build_object('phone', '+1 (416) 555-0102', 'contactPerson', 'Jane Smith', 'address', jsonb_build_object('street', '1411 Warden Ave', 'city', 'Scarborough', 'province', 'ON', 'postal_code', 'M1R 5B7', 'country', 'Canada', 'latitude', 43.7532, 'longitude', -79.2985)), NOW(), NOW()),
    ('20000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'Canadian Tire', 'bob.johnson@canadiantire.ca', 'standard', jsonb_build_object('phone', '+1 (416) 555-0103', 'contactPerson', 'Bob Johnson', 'address', jsonb_build_object('street', '839 Yonge St', 'city', 'Toronto', 'province', 'ON', 'postal_code', 'M4W 2H2', 'country', 'Canada', 'latitude', 43.6735, 'longitude', -79.3867)), NOW(), NOW()),
    ('20000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'Home Depot', 'alice.brown@homedepot.ca', 'standard', jsonb_build_object('phone', '+1 (416) 555-0104', 'contactPerson', 'Alice Brown', 'address', jsonb_build_object('street', '50 Bloor St W', 'city', 'Toronto', 'province', 'ON', 'postal_code', 'M4W 1A1', 'country', 'Canada', 'latitude', 43.6707, 'longitude', -79.3873)), NOW(), NOW()),
    ('20000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000001', 'IKEA Toronto', 'charlie.davis@ikea.ca', 'standard', jsonb_build_object('phone', '+1 (416) 555-0105', 'contactPerson', 'Charlie Davis', 'address', jsonb_build_object('street', '15 Provost Dr', 'city', 'North York', 'province', 'ON', 'postal_code', 'M2K 2X9', 'country', 'Canada', 'latitude', 43.7735, 'longitude', -79.4042)), NOW(), NOW()),
    ('20000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000002', 'Best Buy Toronto', 'diana.wilson@bestbuy.ca', 'premium', jsonb_build_object('phone', '+1 (416) 555-0106', 'contactPerson', 'Diana Wilson', 'address', jsonb_build_object('street', '2200 Yonge St', 'city', 'Toronto', 'province', 'ON', 'postal_code', 'M4S 2C6', 'country', 'Canada', 'latitude', 43.7068, 'longitude', -79.3983)), NOW(), NOW()),
    ('20000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000002', 'Sobeys', 'edward.martinez@sobeys.ca', 'standard', jsonb_build_object('phone', '+1 (416) 555-0107', 'contactPerson', 'Edward Martinez', 'address', jsonb_build_object('street', '595 Bay St', 'city', 'Toronto', 'province', 'ON', 'postal_code', 'M5G 2C2', 'country', 'Canada', 'latitude', 43.6559, 'longitude', -79.3832)), NOW(), NOW()),
    ('20000000-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000003', 'Metro Grocery', 'fiona.garcia@metro.ca', 'standard', jsonb_build_object('phone', '+1 (416) 555-0108', 'contactPerson', 'Fiona Garcia', 'address', jsonb_build_object('street', '87 Front St E', 'city', 'Toronto', 'province', 'ON', 'postal_code', 'M5E 1C3', 'country', 'Canada', 'latitude', 43.6486, 'longitude', -79.3735)), NOW(), NOW()),
    ('20000000-0000-0000-0000-000000000009', '00000000-0000-0000-0000-000000000003', 'Loblaws', 'george.lee@loblaws.ca', 'standard', jsonb_build_object('phone', '+1 (416) 555-0109', 'contactPerson', 'George Lee', 'address', jsonb_build_object('street', '60 Carlton St', 'city', 'Toronto', 'province', 'ON', 'postal_code', 'M5B 1J2', 'country', 'Canada', 'latitude', 43.6615, 'longitude', -79.3792)), NOW(), NOW()),
    ('20000000-0000-0000-0000-00000000000a', '00000000-0000-0000-0000-000000000004', 'Shoppers Drug Mart', 'hannah.kim@shoppersdrugmart.ca', 'standard', jsonb_build_object('phone', '+1 (416) 555-0110', 'contactPerson', 'Hannah Kim', 'address', jsonb_build_object('street', '123 King St W', 'city', 'Toronto', 'province', 'ON', 'postal_code', 'M5H 1A1', 'country', 'Canada', 'latitude', 43.6488, 'longitude', -79.3817)), NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
