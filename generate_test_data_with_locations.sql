...
-- 更新时间: 2025-10-21 16:05:00 - 添加权限设置
...
VALUES 
    ...
    ('b0000000-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000002', 'expense', '30000000-0000-0000-0000-000000000006', 50.00, 'CAD', 'paid', 'Vehicle maintenance', NOW(), NOW()),
    ...
    ('b0000000-0000-0000-0000-00000000000a', '00000000-0000-0000-0000-000000000003', 'expense', '40000000-0000-0000-0000-000000000008', 120.00, 'CAD', 'paid', 'Driver wages payment', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
