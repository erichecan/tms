-- 🎯 Supabase完整测试数据 - 语法错误修复版
-- 2025-10-02 17:35:00 - 修复所有语法错误
...
-- 8. 创建计费组件数据
-- =====================================================
INSERT INTO public.pricing_components (id, tenant_id, code, name, description, category, calculation_type, formula, default_value, unit, currency, is_taxable, status)
VALUES 
('pc001', '00000000-0000-0000-0000-000000000001', 'BASE_FEE', '基础费用', '运输基础费用', 'base', 'fixed', null, 100.00, 'CAD', 'CAD', true, 'active'),
('pc002', '00000000-0000-0000-0000-000000000001', 'DISTANCE_MULTIPLIER', '距离费', '按距离计算的费用', 'distance', 'multiplier', 'distance * 1.2', 0, 'CAD/km', 'CAD', true, 'active'),
('pc003', '00000000-0000-0000-0000-000000000001', 'WEIGHT_FEE', '重量费', '按重量计算的费用', 'weight', 'multiplier', 'weight * 0.15', 0, 'CAD/kg', 'CAD', true, 'active'),
('pc004', '00000000-0000-0000-0000-000000000001', 'EXPRESS_SURCHARGE', '加急费', '加急运输费用', 'surcharge', 'fixed', null, 50.00, 'CAD', 'CAD', true, 'active'),
('pc005', '00000000-0000-0000-0000-000000000001', 'FUEL_SURCHARGE', '燃油附加费', '燃油价格上涨附加费', 'fuel', 'multiplier', 'baseFee * 0.05', 0, 'CAD', 'CAD', true, 'active');

-- =====================================================
-- 9. 创建定价模板
-- =====================================================
INSERT INTO public.pricing_templates (id, tenant_id, name, description, type, business_conditions, pricing_rules, driver_rules, cost_allocation, status)
VALUES 
('pt001', '00000000-0000-0000-0000-000000000001', '标准运输', '标准城市间运输模板', 'CLIENT_DIRECT', 
 '{"distanceRange": {"min": 50, "max": 500}, "cargoType": ["general"], "urgency": "standard"}',
 '[{"componentCode": "BASE_FEE", "order": 1}, {"componentCode": "DISTANCE_MULTIPLIER", "order": 2}, {"componentCode": "FUEL_SURCHARGE", "order": 3}]',
 '[{"driverRatio": 0.6, "description": "司机薪酬占比"}]',
 '{"fuel": 0.15, "maintenance": 0.10, "insurance": 0.05}', 'active');
